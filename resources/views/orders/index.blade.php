        ...
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <div class="mx-auto max-w-5xl">
                <div class="gap-4 sm:flex sm:items-center sm:justify-between">
                    <h2 class="text-xl font-semibold text-gray-900  sm:text-2xl">Customers orders</h2>
                        ...
                        @foreach ($orders as $payment)
                            <div class="flex flex-wrap items-center gap-y-4 py-6">
                                ...
                                <div
                                    ...
                                    <form action="/orders/{{ $payment->id }}" method="post">
                                        @csrf
                                        @method('PUT')
                                        @if ($payment->payment_status == 'Confirmed')
                                            <button type="submit" name="payment_status" value="Check_in"
                                                class="w-full inline-flex justify-center rounded-lg  border border-green-500 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-green-500 hover:text-white focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 lg:w-auto">Check-In</button>
                                        @elseif ($payment->payment_status == 'Check-In')
                                            <button type="submit" name="payment_status" value="Check_out"
                                                class="w-full inline-flex justify-center rounded-lg  border border-red-500 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-red-500 hover:text-white focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 lg:w-auto">Check-Out</button>
                                        @endif
                                        <a href="/orders/{{ $payment->id }}"
